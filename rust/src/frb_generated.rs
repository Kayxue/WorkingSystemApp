...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -673880095;
...
fn wire__crate__api__core__get_image_information_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "get_image_information",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::core::get_image_information(api_path)?;
                        Ok(output_ok)
                    })(),
                )
            }
...
impl SseDecode for crate::api::core::ImageInformation {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return crate::api::core::ImageInformation {
            width: var_width,
            height: var_height,
            ratio: var_ratio,
            format: var_format,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__core__change_filename_extension_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__core__get_image_information_impl(port, ptr, rust_vec_len, data_len),
        3 => {
        ...
        5 => wire__crate__api__core__read_image_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl flutter_rust_bridge::IntoDart for crate::api::core::ImageInformation {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::core::ImageInformation
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::core::ImageInformation>
    for crate::api::core::ImageInformation
{
    fn into_into_dart(self) -> crate::api::core::ImageInformation {
        self
    }
}
...
impl SseEncode for crate::api::core::ImageInformation {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
