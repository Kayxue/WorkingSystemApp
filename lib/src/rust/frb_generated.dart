...
abstract class RustLibApi extends BaseApi {
  ...
  void crateApiWebsocketWebSocketClientSendText({
    required WebSocketClient that,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  void crateApiWebsocketWebSocketClientSendText({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiWebsocketWebSocketClientSendTextConstMeta,
        argValues: [that, text],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiWebsocketWebSocketClientSendTextConstMeta =>
      const TaskConstMeta(
        debugName: "WebSocketClient_send_text",
        argNames: ["that", "text"],
      );
  ...
  Future<(Uint8List, String)> crateApiCaptchaGenerateCaptcha() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiCaptchaGenerateCaptchaConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiCaptchaGenerateCaptchaConstMeta =>
  ...
  bool crateApiPasswordResetIsValidEmail({required String email}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiPasswordResetIsValidEmailConstMeta,
        argValues: [email],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiPasswordResetIsValidEmailConstMeta =>
...
class WebSocketClientImpl extends RustOpaque implements WebSocketClient {
  ...
  void sendText(String text) => RustLib.instance.api
      .crateApiWebsocketWebSocketClientSendText(that: this, text: text);
}
