...
import 'package:working_system_app/Types/JSONObject/Conflict/conflict_return.dart';
import 'package:working_system_app/Widget/ViewConflict/gig_card.dart';
        ...
        child: PagedListView<int, ConfirmedGig>(
          ...
          builderDelegate: PagedChildBuilderDelegate(
            itemBuilder: (context, item, index) =>
                GigCard(gig: item, sessionKey: widget.sessionKey),
          ),
        ),
      ),
    );
